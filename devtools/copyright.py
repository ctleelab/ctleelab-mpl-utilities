...
This script is shamelessly borrowed from the GROMACS project and adapted for use.
"""
...
class CopyrightChecker(object):
    ...
    _copyright = "Copyright {0}- ctleelab"
    _footer = """
This Source Code Form is subject to the terms of the Mozilla Public
License, v. 2.0. If a copy of the MPL was not distributed with this
file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
""".strip().splitlines()
    ...
    def check_copyright(self, comment_block):
        ...
        copyright_re_new = r"Copyright ([0-9]{4})- ctleelab"
